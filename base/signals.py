...
def log_login_failed(sender, credentials, request, **kwargs):
    ...
    log_message("LOGIN FAILED", None, request, extra_details=f"Attempted Username: {username}\n")
    logger.warning(f"Login failed for username: {username} from IP: {ip}, Browser: {user_agent}")
