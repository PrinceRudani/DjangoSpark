    ...
    if request.method == 'POST':
        try:
            ...
            if LoginVO.objects.filter(login_username=login_username).exists():
                return render(request, "admin/login&register/register.html", {"error": "Username already exists."})
            ...
            return render(request, "admin/login&register/login.html", {"success": "Registration successful!"})

        except Exception as e:
            return render(request, "admin/login&register/register.html", {"error": f"Error occurred: {str(e)}"})

    return render(request, "admin/login&register/register.html", {"error": "Invalid request method."})
