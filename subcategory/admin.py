...
class SubCategoryVOAdmin(admin.ModelAdmin):
    ...
    list_display = ('subcategory_id', 'subcategory_name', 'subcategory_category_vo', 'is_deleted', 'create_at', 'modify_at')
    list_filter = ('is_deleted', 'subcategory_category_vo')  # Filter options in admin
    ...
    fieldsets = (
        (None, {
            'fields': ('subcategory_name', 'subcategory_category_vo', 'subcategory_description', 'is_deleted')
        }),
        ('Timestamps', {
