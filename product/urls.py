...
urlpatterns = [
                  ...
                  path("admin_load_ajax/", views.admin_load_ajax,
                       name="admin_load_ajax"),
                  path(
                      "admin_insert_product/", views.admin_insert_product,
                      name="admin_insert_product"
                  ),
                  path("admin_view_product/", views.admin_view_product,
                       name="admin_view_product"),
                  path(
                      "admin_delete_product/", views.admin_delete_product,
                  ...
                  path("product_json/", views.product_json,
                       name="product_json"),
